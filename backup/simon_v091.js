...
//var stringToPlay = "ABCD" // a default value for var -- not used at the moment
...
function generateSimonSound(frequency, time) { 				// generates the sound for Simon | is called by tryToFollowMe															
																							   ...
																							   console.log("Simon freq " + frequency + " Simon Time " + time);
    																							o.start(time);    		
 																		  						...
 																		  						// change the color of the corrispondent played button
...
function changeButtonColor(frequency, time) {
																										 if (frequency == FreqA) {console.log("GREEN BUTTON"); document.getElementById("playA").style.background='#000000';}												  						
 																		  						else if (frequency == FreqB) {console.log("RED BUTTON"); document.getElementById("playB").style.background='#000000';}
 																		  						else if (frequency == FreqC) {console.log("YELLOW BUTTON"); document.getElementById("playC").style.background='#000000';}
 																		  						else if (frequency == FreqD) {console.log("BLUE BUTTON"); document.getElementById("playD").style.background='#000000';}
