...
function checkIfCorrect(){ var index = stepCounter;							
								   				...
								   				if (thePartialSequence == [])	{alert("Press Start");}											
												   else if (thePlayerSequence[index] == thePartialSequence[index] && stepCounter == Limit && Limit == Goal) {setTimeout(nextLevel,1000);} // check if the level is complete and it calls nextLevel function																		
