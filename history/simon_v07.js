...
function listenToMySong() {
														...
														function play(frequency, time) { // gotta figure out this, copied and adapted from https://stackoverflow.com/questions/46175892/audiocontext-how-to-play-the-notes-in-a-sequence
  													  ...
  													  for (var i = 0; i < thePartialFreq.length; i++) {
    																																	 		play(thePartialFreq[i], i * interval);
  																																				}
